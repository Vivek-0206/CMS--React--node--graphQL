...
function EmployeeCreate() {
	...
	return (
		<>
			<Container>
				{isSuccess && (
					<Toast bg='dark' show={toastSuccess} onClose={() => settoastSuccess(false)} delay={3000} autohide>
						<Toast.Header>
							<strong className="me-auto"> Success </strong>
						</Toast.Header>
						<Toast.Body className='text-white'>Employee Added Successfully</Toast.Body>
					</Toast>
				)}

				{error && (
					<Toast bg='dark' show={toastError} onClose={() => settoastError(false)} delay={3000} autohide>
						<Toast.Header>
							<strong className="me-auto"> Error </strong>
						</Toast.Header>
						<Toast.Body className='text-white'>Something went wrong while adding employee. Please try again later.</Toast.Body>
					</Toast>
				)}
				<h1> Add Employee </h1>
				<Form onSubmit={handleSubmit}>
					...
					<Form.Group className="mb-3" controlId="formBasicDOJ">
						...
						{formErrors && formErrors.dateOfJoining && (
							<Form.Text className="text-danger">{formErrors.dateOfJoining}</Form.Text>
						)}
					</Form.Group>
					...
					<Form.Group className="mb-3" controlId="formBasicType">
						...
						{formErrors && formErrors.employeeType && (
							<Form.Text className="text-danger">{formErrors.employeeType}</Form.Text>
						)}
					</Form.Group>
